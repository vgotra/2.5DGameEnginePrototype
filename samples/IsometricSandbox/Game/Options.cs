...
public sealed record Options(bool FlatMode, bool StartFullscreen, bool ShowMetrics, bool ForceParallel, double FrameCap)
{
    public static Options Parse(string[] args)
    {
        ...
        return new Options(flatMode, startFullscreen, showMetrics, forceParallel, ReadFrameCap(args));
    }
