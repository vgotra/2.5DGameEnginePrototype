...
3. **Sample run** — `dotnet run --project <SampleProject>`, including any flag combos you touched, to confirm rendering and window behavior. Flags, controls, tunables, and their defaults are in `.agents/context/ProjectConfig.md`.
