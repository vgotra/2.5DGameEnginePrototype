...
# 37. Revised Milestone 0 — Measure Before Simplifying

Do not change code.

Benchmark current architecture with:
...
This determines the future adaptive parallel thresholds.

---

# 38. Milestone 1 — Game / World / Scene Contracts

Before replacing ECS, introduce clear runtime concepts:
...
Do NOT redesign threading.

Do NOT replace ECS yet.
...
is visible in the sample architecture.
