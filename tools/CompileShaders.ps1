...
& $Compiler (Join-Path $shaderRoot "shape.vert.glsl") -o (Join-Path $shaderRoot "shape.vert.spv")
& $Compiler (Join-Path $shaderRoot "shape.frag.glsl") -o (Join-Path $shaderRoot "shape.frag.spv")
