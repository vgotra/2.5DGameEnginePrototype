...
- BIND Vulkan through the Vortice.Vulkan managed package. USE `[LibraryImport]` ONLY for OS/native-C P/Invoke (Win32 `NativeMethods`, native C libraries such as JoltC). NEVER `[DllImport]`.
